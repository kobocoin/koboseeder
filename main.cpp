...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Kobocoin-seeder\n"
...
static const string mainnet_seeds[] = {"dns1.kobocoin.com", "dns2.kobocoin.com", "dns3.kobocoin.com", "dns4.kobocoin.com"};
static const string testnet_seeds[] = {"testnet-blockchain.kobocoin.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("82.211.31.186", GetDefaultPort()), true);
  }
  do {
